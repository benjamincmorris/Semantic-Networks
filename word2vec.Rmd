...
model = read.vectors("full_vectors.bin")
...
vocab_size <- sapply(51699:57474, function(i) (english_data %>% 
                                   filter(data_id==i) %>% 
                                   filter(value=='produces') %>% 
                                   summarize(vocab_size= n())),
                                   simplify='vector')
ids <- 51699:57474
vocab_size <- sapply(1:length(vocab_size), function(i) vocab_size[i]$vocab_size)
fixed_production <- data.frame(ids, vocab_size)
english_data <- left_join(english_data, fixed_production, by= c("data_id"='ids'))
...
get_entropy <- function(num_words) {
  ...
  entropy(some_vector, unit='log2')
}



normalize <- function(vector) {
  new_vector <- sapply(1:length(vector), function(i) vector[i]/length(vector))
  new_vector
}
...
kids_vocab_entropy <- function(num_words) {
    ...
    entropy(kid_entropy$num_kids, unit='log2')
}

entropy_100 <- replicate(1000, get_entropy(100))
hist(entropy_100)
kids_vocab_entropy(100)
mean(entropy_100 <= kids_vocab_entropy(100))

entropy_300 <- replicate(1000, get_entropy(300))
hist(entropy_300)
kids_vocab_entropy(300)
mean(entropy_300 <= kids_vocab_entropy(300))


entropy_500 <- replicate(1000, get_entropy(500))
hist(entropy_500)
kids_vocab_entropy(500)
mean(entropy_500 <= kids_vocab_entropy(500))

entropy_600 <- replicate(1000, get_entropy(600))
hist(entropy_600)
kids_vocab_entropy(600)
mean(entropy_600 <= kids_vocab_entropy(600))
```
