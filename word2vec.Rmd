...
test <- replicate(100, sample_transitivity(479))



john_graph <- graph_from_adjacency_matrix(
  wordbank_normal[rownames(wordbank_normal) %in% john_data$uni_lemma,
...
# random set of words of matching size
sample(all_items, unique(john_data$production))
