...
cbind(CHILDES_sim_modified, CHILDES_sim["teddy",] + CHILDES_sim["bear",] 
...
order(fixed_items$fixed_item)


rownames(CHILDES_sim_wordbank)
  filter(fixed_item %in% rownames(CHILDES_sim_wordbank)) %>%
  arrange(fixed_item)
...
nearest_to(model, model[["ice"]] + model[["cream"]])
           ...
           ,demo_vectors[["guy"]] - demo_vectors[["man"]] + demo_vectors[["woman"]])
